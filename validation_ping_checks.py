    ...
    def updateParameters(self):
        ...
        if self.params[2].value == True:
            ...
            if token_text:
                ...
                free_worker = fb_result['data'][1]['attributes']['free_worker_ping']
                busy_worker = fb_result['data'][1]['attributes']['busy_worker_ping']
                ...
                for i in range(len(fb_result['data'])):
                    ...
                    if check_free < control_20_secs or check_busy < control_20_secs:
